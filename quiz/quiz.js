...
function optionSelected(answer){
    ...
    /* 
    Har lavet et lidt scuffed fix for at tillade flere korrekte svar i det 5. spørgsmål.
    Hvis svaret er et array (dvs. hvis der er flere rigtige svar) så er brugerens svar altid rigtigt.
    */
    if(userAns == correcAns || correcAns instanceof Array){ //if user selected option is equal to array's correct answer
...
function showResult(){
    ...
    if (userScore > 5){ // if user scored more than 5
        ...
        let scoreTag = '<span>Desværre. Du fik kun <p>'+ userScore +'</p> rigtige ud af <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
}
